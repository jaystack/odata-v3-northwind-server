...
var strategy = {
    ...
    save: function save(provider, convertedItems, callBack) {
        ...
        var requestData = [{
            ...
            headers: {
                "OData-Version": that.providerConfiguration.dataServiceVersion,
                "OData-MaxVersion": that.providerConfiguration.maxDataServiceVersion
            }
...
var RequestBuilder = exports.RequestBuilder = function () {
    ...
    _createClass(RequestBuilder, [{
        ...
        value: function build() {
            ...
            this._request.headers["OData-Version"] = this._context.providerConfiguration.dataServiceVersion;
            this._request.headers["OData-MaxVersion"] = this._context.providerConfiguration.maxDataServiceVersion;
